            ...
            >
                    ...
                    <Grid container spacing={6}>
                        ...
                        <Grid item xs={12} sx={{ mt: -2.5, textAlign: { xs: 'center', md: 'left' } }}>
                            ...
                            >
                                ...
                                >
                                    Instantly transfer, deposit,and withdraw funds Banking , simplified and streamlined
                                </Typography>
                            </motion.div>
                        </Grid>
                        <Grid item xs={12}>
                ...
                <Grid item xs={12} md={7} sx={{ display: { xs: 'none', md: 'flex' } }}>
                    <Box sx={{ position: 'relative', mt: 8.75, zIndex: 9 }}>
                        <HeaderImage src={dashboard} alt="ABC" />
                        <Box
                            sx={{
                                position: 'absolute',
                                top: { md: -35, lg: -110 },
                        ...
                        >
                            <motion.div
                                ...
                                transition={{ type: 'spring', stiffness: 150, damping: 30, delay: 0.2 }}
                            >
                                <HeaderAnimationImage src={widget1} alt="ABC" />
                            </motion.div>
                        </Box>
                        <Box
                            sx={{
                        ...
                        >
                            <motion.div
                                ...
                                transition={{ type: 'spring', stiffness: 150, damping: 30, delay: 0.4 }}
                            >
                                <HeaderAnimationImage src={widget2} alt="ABC" />
                            </motion.div>
                        </Box>
                    </Box>
